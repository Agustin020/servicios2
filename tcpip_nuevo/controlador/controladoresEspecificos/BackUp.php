...
define("DB_USER", 'rk000488_wordpre' /* 'root'*/);
define("DB_PASSWORD", 'bezaDO99fi' /* 'root'*/);
define("DB_NAME", 'rk000488_base');
define("DB_HOST", 'localhost');
define("BACKUP_DIR", '../../modelo'); // Comment this line to use same script's directory ('.')
...
class Backup_Database {
    ...
    public function backupTables($tables = '*') {
        try {
            ...
            foreach ($tables as $table) {
                $this->obfPrint("Haciendo BackUp tabla '" . $table . "'..." . str_repeat('.', 50 - strlen($table)), 0, 0);
                /**
                 * CREATE TABLE
                 */
            ...
            if ($this->gzipBackupFile) {
                ...
                $this->obfPrint('Archivo de Backup guardado en ' . $this->backupDir . '/' . $this->backupFile, 1, 1);
            }
        } catch (Exception $e) {
            print_r($e->getMessage());
            return false;
    ...
    public function btnVolver() {
        ...
        echo '<center><a href="../../vista/html/admin.html"><h1>VOLVER</h1></a></center>';
    }

public function btnBackUp() {

        echo '<center><a href="../../modelo/"><h3>DESCARGAR BACKUP</h3></a></center>';
    }
...
$backupDatabase->btnVolver();
$backupDatabase->btnBackUp();
if (php_sapi_name() != "cli") {
    echo '</div>';
}