 ...
 * @author Flaco
 */
class ControladorBuscarOrden extends ControladorGeneral{
    public function buscar() { //buscarOrdenEmpresa
                $pepe=new prueba();
                $fecha=$pepe->fecha30();
        try {
            $this->refControladorPersistencia->get_conexion()->beginTransaction();  //comienza la transacción
            $statement = $this->refControladorPersistencia->ejecutarSentencia(DBSentencias::BUSCAR_ORDEN_TODOS);
    ...
    public function buscare() { //buscarOrdenEmpresa
                $pepe=new prueba();
                $fecha=$pepe->fecha30();
        try {
            $this->refControladorPersistencia->get_conexion()->beginTransaction();  //comienza la transacción
