$(document).ready(function() {
  ...
  function fetchPalette() {
    ...
    palettes[0] = [
              ['#FF0000','#00FF00','#0000FF','#FFFFFF','#00FFFF','#FF00FF','#FFFF00','#000000','#808080','#800080','#80FFFF','#000080'],
  ...
  function generateHTML() {
    ...
    for (var palette in palettes) {
      html[palette] = '<table id="palette-table" cellpadding="0" cellspacing="2" style="border-collapse: separate; border-spacing: 2px; padding: 0px;margin:0; width: 290px;">';
