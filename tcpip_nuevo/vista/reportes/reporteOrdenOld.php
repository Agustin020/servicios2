...
//$file = "../imagenes/tcpipLogoPagina.jpg";
...
//$pdf->Ln();
//$pdf->Cell(100, 7, utf8_decode($orden['falla_cliente_orden']), 0, 0, 'L');
//$pdf->SetY(120);
...
//}
//
//$pdf->Image($file, 10, 138, 70);
//$pdf->ln();
//$pdf->SetFont('Arial', '', '8');
//$pdf->SetX(150);
//$pdf->SetTextColor(2, 6, 144);
//$pdf->MultiCell(30, 3, utf8_decode('TCP/IP Tecnología 20-27982272-3 Presidente Alvear 58 Godoy Cruz 5501 MENDOZA 4248100 155999902'), 0, 'R');
////$this->Cell(150,20,utf8_decode('20-27982272-3'),0,0,'R');
//$pdf->Ln();
//$pdf->Ln();
//
...
//$pdf->Cell(35, 4, $formatoFecha, 1, 0, 'C', true);
...
if ($_GET["estado"] < "13") {
    foreach ($ordenes as $orden) {
        if ($alterna) {
            ...
            $pdf->Ln();
            $pdf->multiCell(200, 4, utf8_decode($orden['falla_cliente_orden']), 0, 'L');
        ...
        foreach ($ordenes as $orden) {
            ...
            if ($final == $cont + 1) {
                ...
                $pdf->SetFont('Arial', 'I', '7');
                $pdf->Ln();
                $pdf->multiCell(200, 3, utf8_decode($orden['falla_cliente_orden']), 0, 'L');
                $pdf->Ln();
                $pdf->Ln();
                if($_GET["id"] === "375"){
                $pdf->MultiCell(200, 4, utf8_decode("El producto entregado, es nuevo y se verifica el funcionamiento con el cliente. La aceptación del producto supone que le cliente recibe en conformidad un equipo de las mismas caracteristicas del siniestrado y no se aceptan cambios, ni devoluciones del mismo"), 0, 'L');
            }
